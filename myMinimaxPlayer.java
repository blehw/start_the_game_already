...
public class myMinimaxPlayer extends SampleGamer {
...
function maxscore (role,state)
  ...
  */
	...
	private int minScore(Role role, Move move, MachineState state) throws GoalDefinitionException, TransitionDefinitionException, MoveDefinitionException {
